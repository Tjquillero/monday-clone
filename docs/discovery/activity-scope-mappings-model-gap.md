...
**Pendiente, fuera de alcance de este hallazgo:** las ~88 actividades restantes del POA (bloqueadas hoy por `docs/discovery/poa-rendimiento-decision-request.md`) también necesitarán su propia fila en esta tabla puente cuando se confirmen sus rendimientos — ese trabajo se hace entonces, no ahora.
