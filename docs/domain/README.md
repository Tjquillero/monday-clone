...
| [`evidence-domain.md`](./evidence-domain.md) | **Congelado (v1)** | Evidencia e Integridad de Adjuntos: Capa B Operacional. Hashing SHA-256, tres relojes de tiempo, inmutabilidad post-certificación. |
| [`evidence-curation-domain.md`](./evidence-curation-domain.md) | **Congelado (v1)** | Curaduría de Evidencia y Presentación en Actas: Capa C Productización. Separación de persistencia, curaduría por actividad, motor determinístico v1 reproducible, selección humana y snapshot inmutable en ISSUED. |
